...
import os, sys, re, json, ast, subprocess, threading, queue
...
# ---------------------- JSON & Config ----------------------
# Runtime-safe paths: works from source, GitHub clone, PyInstaller EXE, or installed app.
if getattr(sys, "frozen", False):
    ROOT_DIR = os.path.dirname(sys.executable)
else:
    ROOT_DIR = os.path.dirname(os.path.abspath(__file__))
CONFIG_DIR_DEFAULT = os.path.join(ROOT_DIR, "config")
